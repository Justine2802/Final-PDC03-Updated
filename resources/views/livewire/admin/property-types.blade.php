<div>
    ...
    <div class="flex items-center justify-between mb-6">
        <div>
            <h1 class="text-xl font-semibold text-foreground font-serif tracking-tight">Property Types</h1>
            <p class="text-xs text-dim mt-1">Configure the types of properties available.</p>
        </div>
            ...
            <table class="w-full text-sm">
                <thead>
                    <tr class="border-b border-line bg-subtle/50">
                        ...
                        <th class="px-4 py-2.5 text-left text-[10px] font-semibold text-dim uppercase tracking-[0.1em]">Properties</th>
                        <th class="px-4 py-2.5 text-left text-[10px] font-semibold text-dim uppercase tracking-[0.1em]">
