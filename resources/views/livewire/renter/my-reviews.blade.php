                                ...
                                <div class="flex flex-col items-end gap-2 flex-shrink-0">
                                    ...
                                    <div class="flex items-center gap-1.5 mt-1">
                                        <button wire:click="openReviewForm({{ $review->reservation_id }})"
                                                title="Edit review"
                                                class="inline-flex items-center gap-1.5 px-2.5 py-1.5 rounded-sm border border-line text-xs font-medium text-dim hover:text-foreground hover:border-foreground/40 hover:bg-subtle transition-all">
                                        ...
                                        <button wire:click="deleteReview({{ $review->id }})"
                                                ...
                                                title="Delete review"
                                                class="inline-flex items-center gap-1.5 px-2.5 py-1.5 rounded-sm border border-red-200 dark:border-red-500/30 text-xs font-medium text-red-500 dark:text-red-400 hover:bg-red-50 dark:hover:bg-red-500/10 hover:border-red-300 dark:hover:border-red-500/50 transition-all">
                                            <svg class="w-3 h-3" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
